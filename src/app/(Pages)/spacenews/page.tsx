...
export default function SpaceNewsPage() {
  ...
  return (
      ...
      <div className="min-h-screen text-gray-100 font-semibold text-3xl ">
 ...
 */}
<ShootingStars className="-z-10" maxSpeed={10} minDelay={2000} starColor="white" trailColor="blue" starWidth={60} />
      </div>
  );
} 
