...
const cardData: CardData[] = [
  {
    ...
    description: "Embark on an interstellar adventure and explore the wonders of our solar system. Discover planets, moons, and the beauty of space.",
    imageUrl: "https://i.redd.it/rb4uyyz4crwa1.jpg",
    tryNowLink: "/solarsystem",
  },
  {
    title: "Constellations: A Celestial Map",
    description: "Unlock the secrets of the night sky as you hover over constellations. Learn their stories and navigate through the stars.",
    imageUrl:
  ...
  },
  {
    ...
    description: "Discover the mythical tales behind constellations. Dive deep into the legends that shaped our understanding of the cosmos.",
    imageUrl:
  ...
  },
  {
    ...
    description: "Learn about the asteroids that traverse our solar system. Understand their origins and their impact on Earth and beyond.",
    imageUrl:
  ...
  },
  {
    ...
    description: "Dive into the world of satellites and learn how they help us understand our planet and the universe. Explore their functions and history.",
    imageUrl:
  ...
  },
  {
    ...
    description: "Put your space knowledge to the test! Participate in our cosmic quiz and challenge yourself with questions about the universe.",
    imageUrl:
