...
const cardData: CardData[] = [
  ...
  },
  {
    ...
    description:
      "Get the latest in space exploration and astronomy—breaking news, mission updates, and discoveries that shape our universe.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Embark on a cosmic adventure! Navigate your spaceship, complete missions, and discover hidden treasures while learning about the universe. Ready for the challenge?",
    imageUrl:
...
const ThreeDCard: React.FC = () => {
  return (
    <>
      <div className="grid  md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-1 mt-10 m-[200px] text-black text-xl ">
            ...
            <CardBody  className=" bg-transparent border-white relative group/card dark:hover:shadow-2xl bg-blend-darken w-auto sm:w-[30rem] h-auto rounded-xl p-6 border shadow-md hover:shadow-white">
              ...
              <div className="flex justify-between items-center mt-10">
                <CardItem
                  ...
                  as={Link}
                  href={card.tryNowLink}
                  className="flex items-center justify-center px-4 py-2 w-full h-16 rounded-xl bg-transparent backdrop-blur-sm border-white text-white text-xl font-bold border-2 hover:bg-white hover:text-black hover:shadow-slate-500 shadow-sm relative"
                >
                  <span
                    style={{
                      position: "absolute",
                      ...
                      boxShadow:
                        "0 0 5px rgba(0, 213, 255, 0.75), 0 0 10px rgba(0, 213, 255, 0.5), 0 0 20px rgba(0, 213, 255, 0.5), 0 0 40px rgba(0, 213, 255, 0.3)",
